...
import {buildConfig} from '@segment/tools';
...
const materialOutPath = join(buildConfig.outputDir, 'packages', 'ui');

/** Path to the output of the CDK package. */
const cdkOutPath = join(buildConfig.outputDir, 'packages', 'carbon');
